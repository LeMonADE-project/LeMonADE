...
public:
	...
	//! constructor
	AnalyzerMonomerMSD(const IngredientsType& ingredients_, uint32_t equilibrationTime_=0, std::string output_="MonomerMSD.dat");
...
void AnalyzerMonomerMSD<IngredientsType>::initialize()
{
  ...
  BaseClass::setOutputFilename(std::string("MonomerMSD").append(output).append(".dat").c_str());
