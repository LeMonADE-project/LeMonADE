 ...
 * the same numbers. A conveniece function seedAll is supplied to randomly
 * seed all supplied generators.
 * Furthermore, the class provides a conveniece function for randomly seeding std::rand()
 * from /dev/urandom
 * 
 **/
