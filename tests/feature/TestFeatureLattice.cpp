...
/**
 * @file
 * @brief Tests for the FeatureLattice
 *
 * @author Ron
 * @date 17.07.2014
 * */
...
class FeatureLatticeTest: public ::testing::Test{
public:
...
/************************************************************************/
TEST_F(FeatureLatticeTest, Synchronize1){

	typedef LOKI_TYPELIST_1(FeatureLattice<bool> ) Features;
...
/************************************************************************/
TEST_F(FeatureLatticeTest, Synchronize2){

	typedef LOKI_TYPELIST_1(FeatureLattice<uint8_t> ) Features;
	typedef ConfigureSystem<VectorInt3,Features> Config;
	typedef Ingredients<Config> Ing;
...
/************************************************************************/
TEST_F(FeatureLatticeTest, Synchronize3){

	typedef LOKI_TYPELIST_1(FeatureLattice<uint32_t> ) Features;
	typedef ConfigureSystem<VectorInt3,Features> Config;
	typedef Ingredients<Config> Ing;
...
/************************************************************************/
TEST_F(FeatureLatticeTest, Synchronize4){
...
/************************************************************************/
TEST_F(FeatureLatticeTest, Synchronize5){
...
/************************************************************************/
TEST_F(FeatureLatticeTest, SetGetLattice1){
...
/************************************************************************/
TEST_F(FeatureLatticeTest, SetGetLattice2){
...
/************************************************************************/
TEST_F(FeatureLatticeTest, SetGetLattice3){

	typedef LOKI_TYPELIST_1(FeatureLattice<int8_t> ) Features;
	typedef ConfigureSystem<VectorInt3,Features> Config;
	typedef Ingredients<Config> Ing;
...
//checks if set and getLatticeEntry for lattice type bool
/************************************************************************/
TEST_F(FeatureLatticeTest, SetGetLattice4){
...
//checks if set and getLatticeEntry for lattice type uint8_t
/************************************************************************/
TEST_F(FeatureLatticeTest, SetGetLattice5){
...
//checks if set and getLatticeEntry for lattice type int8_t
/************************************************************************/
TEST_F(FeatureLatticeTest, SetGetLattice6){
...
/************************************************************************/
TEST_F(FeatureLatticeTest, SetGetLattice7){
...
/************************************************************************/
TEST_F(FeatureLatticeTest, SetGetLattice8){
...
/************************************************************************/
TEST_F(FeatureLatticeTest, SetGetLattice9){
...
/************************************************************************/
TEST_F(FeatureLatticeTest, MoveOnLattice1){
...
/************************************************************************/
TEST_F(FeatureLatticeTest, MoveOnLattice2){
...
/************************************************************************/
TEST_F(FeatureLatticeTest, MoveOnLattice3){
...
//checks the moveOnLattice for lattice type bool
/************************************************************************/
TEST_F(FeatureLatticeTest, MoveOnLattice4){
...
//checks the moveOnLattice for lattice type uint8_t
/************************************************************************/
TEST_F(FeatureLatticeTest, MoveOnLattice5){
...
//checks the moveOnLattice for lattice type int8_t
/************************************************************************/
TEST_F(FeatureLatticeTest, MoveOnLattice6){
